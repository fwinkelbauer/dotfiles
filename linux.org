...
This is my setup script for Xubuntu 22.04:
...
sudo apt -y install emacs git keepassxc homebank dotnet6
...
#+begin_src sh :tangle "~/.local/bin/my-crash" :shebang "#!/bin/bash"
set -euo pipefail
