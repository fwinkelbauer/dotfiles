...
- Configure browser and mail client
...
#+begin_src fundamental :tangle "~/.chunkyard.config"
--repository .chunkyard --prompt Libsecret
#+end_src
...
chunkyard store --repository "$local" --paths "${directories[@]}" --include "${includes[@]}" --prompt 'Libsecret' --parallel '4' "$@"
#+end_src
