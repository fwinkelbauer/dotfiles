...
(defun fw/open-directory-externally ()
  (interactive)
  "Open the `default-directory' using the system default application"
  (embark-open-externally default-directory))
#+end_src
...
(transient-define-prefix fw/transient-main ()
  ...
  [["Search"
   ...
   ["Buffer"
    ...
    ("d" "Open directory" fw/open-directory-externally)]
